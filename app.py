...
# ---------------------------------------------------------
# 4. القائمة الشاملة للأسهم المتوافقة مع الشريعة (المصادر الموثوقة: الأزهر + AAOIFI)
# ---------------------------------------------------------
...
if not api_key:
    ...
    with st.spinner("⏳ جاري سحب الأسعار والأخبار اللحظية للأسهم الإسلامية المنقاة..."):
